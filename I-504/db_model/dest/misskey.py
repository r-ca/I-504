...
class DestMisskeyAccounts(Base):
    ...
    linked_source_id = Column(String(36), ForeignKey('source_items_junction.item_id')) # 1つのソースと固定で紐付けられている場合のソースのID
...
class DestMisskeyNotes(Base):
    ...
    source_id = Column(String(36), ForeignKey('source_items_junction.overall_id')) # UUID
